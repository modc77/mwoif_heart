...
from .ds_v4 import compact_json_bytes, decode_v4_data_b64, decode_v4_form_body, encode_v4
from .heart_ds import _game_process_ms, _meta, _new_cable, _timezone_distance_seconds
...
def bootstrap_session(cfg, slot: str, auth: AuthRecord, event_cb: Event | None = None) -> SessionRecord:
    ...
    return SessionRecord(
        schema="mwoif-session-v2-runtime",
        slot=slot,
